...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment1 
   ...
   _ExtentY        =   19288
   FolderFlags     =   5
   TypeLibGuid     =   "{A066A881-651E-490F-B277-AA3B3EF039E4}"
   TypeInfoGuid    =   "{B30D94EC-9A7B-4520-B8BD-DC65CABE1917}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   ...
   BeginProperty Recordset1 
      ...
      BeginProperty Field12 
         ...
         Scale           =   0
         Type            =   11
         Name            =   "CanSellBelowCost"
         Caption         =   "CanSellBelowCost"
      EndProperty
   ...
   BeginProperty Recordset3 
      ...
      CommDispId      =   1034
      RsDispId        =   1068
      CommandText     =   "SELECT brand FROM brands ORDER BY brand"
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Locktype        =   3
      IsRSReturning   =   -1  'True
   ...
   BeginProperty Recordset4 
      ...
      CommDispId      =   1038
      RsDispId        =   1071
      CommandText     =   "SELECT color FROM colors ORDER BY color"
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Locktype        =   3
      IsRSReturning   =   -1  'True
   ...
   BeginProperty Recordset5 
      ...
      CommDispId      =   1044
      RsDispId        =   1073
      CommandText     =   "SELECT origin FROM origins ORDER BY origin"
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Locktype        =   3
      IsRSReturning   =   -1  'True
   ...
   BeginProperty Recordset8 
      CommandName     =   "catogory"
      CommDispId      =   1062
      RsDispId        =   1067
      CommandText     =   "Catogory"
      ActiveConnectionName=   "Connection1"
      CommandType     =   2
      dbObjectType    =   1
      Locktype        =   3
   ...
   BeginProperty Recordset9 
      ...
      CommDispId      =   1074
      RsDispId        =   1078
      CommandText     =   "SELECT types.* FROM types"
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Locktype        =   3
      IsRSReturning   =   -1  'True
   ...
   BeginProperty Recordset13 
      CommandName     =   "dailysales"
      CommDispId      =   1089
      RsDispId        =   1092
      CommandText     =   "daily_sales"
      ActiveConnectionName=   "Connection1"
      CommandType     =   2
      dbObjectType    =   1
      Locktype        =   3
   ...
   BeginProperty Recordset14 
      CommandName     =   "salesitems"
      CommDispId      =   1093
      RsDispId        =   1096
      CommandText     =   "sales_items"
      ActiveConnectionName=   "Connection1"
      CommandType     =   2
      dbObjectType    =   1
      Locktype        =   3
   ...
   BeginProperty Recordset16 
      CommandName     =   "rptSalesSummry"
      CommDispId      =   1103
      RsDispId        =   1113
      CommandText     =   $"DataEnvironment1.dsx":008A
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Prepared        =   -1  'True
      Locktype        =   3
      ...
      BeginProperty Field4 
         ...
         Caption         =   "CashSales"
         Control         =   "CheckBox"
         ControlGuid     =   "{0CA5C780-7C71-11D0-B223-00A0C908FB55}"
      EndProperty
      NumGroups       =   0
      ParamCount      =   0
      RelationCount   =   0
